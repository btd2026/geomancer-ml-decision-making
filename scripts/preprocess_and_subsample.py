#!/usr/bin/env python3
"""
Preprocess and subsample CELLxGENE datasets for PHATE analysis.

This script:
1. Loads full H5AD files from /Geomancer_2025_Data/processed/
2. Subsamples to max_cells (default 50,000)
3. Saves to /Geomancer_2025_Data/preprocessed/
4. Generates experiment configs for ManyLatents
"""
...
def preprocess_dataset(
    ...
    """
    Preprocess and subsample a single dataset.
    ...
    try:
        ...
        if n_cells_orig > max_cells:
            ...
            print(f"  Keeping all {n_cells_orig:,} cells")
            subsampled = False
        ...
        # Get experiment name from filename (remove .h5ad extension)
...
def main():
    parser = argparse.ArgumentParser(
        description="Preprocess and subsample CELLxGENE datasets"
    )
    parser.add_argument(
        "--input-dir",
        type=str,
